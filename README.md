...
1. Приложение должно корректно отображаться на всех актуальных размерах экрана iPhone, поддерживаемых iOS 17.0, от самых компактных моделей до самых больших;
